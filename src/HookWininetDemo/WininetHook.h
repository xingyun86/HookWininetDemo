...
typedef BOOL (WINAPI* PFN_InternetReadFileExA)(_In_ HINTERNET hFile, _Out_ LPINTERNET_BUFFERSA lpBuffersOut, _In_ DWORD dwFlags, _In_opt_ DWORD_PTR dwContext);
typedef BOOL (WINAPI* PFN_InternetReadFileExW)(_In_ HINTERNET hFile,_Out_ LPINTERNET_BUFFERSW lpBuffersOut,_In_ DWORD dwFlags,_In_opt_ DWORD_PTR dwContext);
...
private:
	...
	static BOOL WINAPI _InternetReadFile(_In_ HINTERNET hFile, _Out_ LPVOID lpBuffer, _In_ DWORD dwNumberOfBytesToRead, _Out_ LPDWORD lpdwNumberOfBytesRead);
	static BOOL WINAPI _InternetReadFileExA(_In_ HINTERNET hFile, _Out_ LPINTERNET_BUFFERSA lpBuffersOut, _In_ DWORD dwFlags, _In_opt_ DWORD_PTR dwContext);
	static BOOL WINAPI _InternetReadFileExW(_In_ HINTERNET hFile, _Out_ LPINTERNET_BUFFERSW lpBuffersOut, _In_ DWORD dwFlags, _In_opt_ DWORD_PTR dwContext);
